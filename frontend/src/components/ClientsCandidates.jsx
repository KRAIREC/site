    ...
    <>
      ...
      <Dialog open={isClientOpen} onOpenChange={setIsClientOpen}>
        <DialogContent className="sm:max-w-[600px]">
          ...
          <ContactForm formType="hire-talent" onSuccess={() => setIsClientOpen(false)} />
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isCandidateOpen} onOpenChange={setIsCandidateOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-gray-900">Submit Your CV</DialogTitle>
            <DialogDescription className="text-gray-600">
              Tell us about your career aspirations and experience.
            </DialogDescription>
          </DialogHeader>
          <ContactForm formType="submit-cv" onSuccess={() => setIsCandidateOpen(false)} />
        </DialogContent>
      </Dialog>
    </>
  );
